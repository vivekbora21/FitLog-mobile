// Palettes and layout tokens. Components read the active palette through `useTheme()` / `makeStyles()`
// (see ThemeProvider) so a theme switch re-renders in place.
...
export type Shadows = ReturnType<typeof shadowsFor>;
